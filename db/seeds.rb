...
FriendRequest.create(young_user: john, old_user: jesse, status: "Accepted", request_message: "Dear Jesse, I have seen on your profile, that you are a soccer fan. I am playing almost every weekend, maybe you could come and watch (in Nørrebro). Aftewards we could grab a drink, if you would like that. Best, John")
FriendRequest.create(young_user: john, old_user: bill, status: "Pending", request_message: "Dear Bill, I found your bio to be really interesting, because I am also aspiring to become an actor just like you. Do you maybe want to meet up one day for a walk and talk a bit? Best regards, John")
